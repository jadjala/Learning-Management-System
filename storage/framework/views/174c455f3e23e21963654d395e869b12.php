<!DOCTYPE html>
<html lang="en" class="<?php echo e(session('dark_mode', false) ? 'dark' : ''); ?>">
<head>
                    ...
                    <div class="ml-10 flex space-x-4">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(Auth::user()->isStudent()): ?>
                                <a href="<?php echo e(route('bookmarks.index')); ?>">Bookmarks</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\Judd\LMS\resources\views/layouts/simple.blade.php ENDPATH**/ ?>